                ...
                tableData.map((data: any, index: number) => {
                    return (
                        <TableRow key={data._id}>
                            ...
                            <TableCell sx={{ color: 'secondary.100' }}>{loading ? <Skeleton sx={{ bgcolor: 'secondary.100' }} /> : data.votes[0].voters.length} </TableCell>
...
export default RenderElectionResultsData;